...
<div class="flex justify-center w-full mb-5 mt-5">
  <form id="form" action="../controllers/serviceController.php?vOpcao=1" method="post" class="border w-1/3 h-fit items-center flex flex-col gap-2 rounded-xl pt-5 pb-5" enctype="multipart/form-data">
