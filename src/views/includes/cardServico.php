<a class="w-36 h-64" href="">
    <div class="relative group shadow-md w-full h-full rounded-2xl overflow-hidden cursor-pointer">
        ...
        <div class="absolute inset-0 bg-black bg-opacity-50 flex items-end justify-start opacity-0 group-hover:opacity-100 transition-opacity duration-300">
